...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2023 at 03:05 AM
...
(6, 13, 'ketua', 'Ai robot', 'unuyo', '2023-01-03', '2023-01-12', '2023-01-18', '6 bulan', 500000, 400000, 9012345, '2023-01-24', 'Pengisian EDOM Bagi Mahasiswa.pdf');
...
CREATE TABLE `pengabdian` (
  ...
  `no_sk_penugasan` int(30) NOT NULL,
  `tanggal_penugasan` date NOT NULL,
  `dana_institusi_lain` int(20) NOT NULL,
  `dana_pt` int(20) NOT NULL,
...
(2, 12, 'ketua', 'minyak bumi', 'unuyo', '2023-01-09', '2023-01-11', '2023-01-13', '1 tahun', 90000000, 450000, 9012345, '2023-01-15', 500000, 8000000, 'cv sejati', 'pelayanan', 'pernyataan_merged.pdf');
...
(2, 13, 'prosidiy', 'hki', 'iot tumbuhan', '2022-11-30', '20', 'dr h kardijo', '345612390', 'www.ilm.com', 'template_nilai.pdf'),
...
(9, 12, 'jurnal internasional bereputasi', 'pembicara', 'intern pub', '2022-12-25', '15', 'mr imran', '980789765091', 'www.ilm.com', 'Basis data_kelompok 10.pdf'),
...
(12, 'agus', 'agus@gmail.com', '01c3c766ce47082b1b130daedd347ffd', 'agus123', 'user', 'agus lena', '5578452309', 'teknik komputer', 'guru besar', '081723456981', '2022-11-27', 'css-logo.jpg'),
(13, 'indri', 'indri@gmail.com', '47370fd01903b707d9e393e735b9e22a', 'indri12', 'user', 'indriyanti', '9089786752', 'teknologi hasil pertanian', 'lektor', '085678984123', '2022-06-05', 'zhumu background.jpg');
...
--
ALTER TABLE `penelitian`
  MODIFY `id_penelitian` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `pengabdian`
--
ALTER TABLE `pengabdian`
  MODIFY `id_pengabdian` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `user`
  MODIFY `id_user` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
COMMIT;
